...
def create_gif(filenames, duration, gifName="generatedGif"        ,fontSize =15,drawCounter=False,resize= 1,grayScale = False,blur = 0):
    images = []
    counter =0
    ...
    clip.write_gif('{}.gif'.format(gifName), fps=fps, loop = False)
